...
const anotherfn = async () => {
  ...
  console.log('Yo aparezco después del que la promesa se cumpla');
}
...
const fnAsync = () => {
  return new Promise((resolve, reject) => {
    ...
    ?
    setTimeout(() => resolve('Async!!', 2000)): reject(new Error('Error!')); //arroja "error" en caso de que la condición sea false
  });
}
